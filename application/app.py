...
with st.sidebar:
    ...
    st.markdown(
        ...
        "For detailed code, please refer to [Github](https://github.com/aws-samples/sample-build-a-life-science-research-assistant-using-strands-agents)."
    )
...
if not st.session_state.greetings:
    with st.chat_message("assistant"):
        intro = "Thank you for using Drug Discovery Agent based on Amazon Bedrock. How may I help you today?"
        st.markdown(intro)
