...
class TestMCPSessionManager(unittest.TestCase):
    ...
    def test_set_active_clients(self):
        ...
        self.assertEqual(stored_clients['clinicaltrials'], self.mock_clinicaltrials_client)
        ...
        for client_type in self.client_sessions.keys():
            ...
            self.assertEqual(status[client_type]['client'], self.client_sessions[client_type])
...
class TestMCPSessionDistribution(unittest.TestCase):
    ...
    def test_client_session_distribution(self, mock_create_orchestrator, 
        ...
        mock_clinicaltrials_client.__enter__ = Mock(return_value=mock_clinicaltrials_client)
        ...
        with patch.object(chat, '_session_manager') as mock_session_manager:
            ...
            async def run_test():
                return chat.run_multi_agent_system(self.test_query, "Disable", self.mock_st)
    ...
    def test_multiple_agent_calls_reuse_same_client(self):
        ...
        with patch('chat.web_search_agent_impl') as mock_impl:
            ...
            for call in mock_impl.call_args_list:
                self.assertEqual(call[0][1], self.mock_client)  # Second argument is the client
...
class TestErrorHandlingForUnavailableClients(unittest.TestCase):
    ...
    def test_agent_tools_handle_unavailable_clients(self):
        ...
        agents_and_expected_errors = [
            ...
            (chat.clinicaltrials_research_agent, "ClinicalTrials client session not available")
        ]
